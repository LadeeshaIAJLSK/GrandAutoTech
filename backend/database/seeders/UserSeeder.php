...
class UserSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $users = [
            ...
            [
                'name' => 'Kandy Branch Manager',
                'email' => 'kandy.manager@grandautotech.lk',
                'phone' => '+94771234572',
                'employee_code' => 'GAT006',
                'password' => Hash::make('password123'),
                'role_id' => $branchAdminRole,
            ...
            [
                'name' => 'Accountant Kumara',
                'email' => 'accountant.kandy@grandautotech.lk',
                'phone' => '+94771234573',
                'employee_code' => 'GAT007',
                'password' => Hash::make('password123'),
                'role_id' => $accountantRole,
                'branch_id' => $kandyBranch,
                'is_active' => true,
            ...
            [
                'name' => 'Support Staff Anil',
                'email' => 'support.kandy@grandautotech.lk',
                'phone' => '+94771234575',
                'employee_code' => 'GAT009',
                'password' => Hash::make('password123'),
                'role_id' => $supportStaffRole,
                'branch_id' => $kandyBranch,
                'is_active' => true,
